...
const schemas = {
  ...
  '382aa542-a2aa-4d62-a2cf-ce5a47382585': {
    ...
    data: {
      ...
      l3lml0h5: {
        ...
        title: 'MainTab',
        children: ['l3lml0ib', 'l3lml0ht', 'l3lml0ih', 'l3lml0ij', 'l3lml0in', 'l3lml0ip'],
        compSchemaId: 'f6b1a985-be84-474e-a4a5-164a76eec249',
      },
      l3lml0h7: {
        id: 'l3lml0h7',
  ...
  '7ef2303b-8e6c-49c5-bdf7-df4bb29523ec': {
    id: '7ef2303b-8e6c-49c5-bdf7-df4bb29523ec',
    title: 'DimensionTree',
    componentName: 'DimensionTree',
    type: 'COMP',
    data: {
      ROOT_ID: {
        id: 'ROOT_ID',
  ...
  '9f2e1391-73ba-4627-8b50-9c07bb31f010': {
    id: '9f2e1391-73ba-4627-8b50-9c07bb31f010',
    title: 'Artem_Test',
    componentName: null,
    type: 'FORM',
    data: {
      ...
      l3vm4e5y: {
        ...
        title: 'Stack',
        children: ['l3vm4e7w', 'l3vm4e80', 'l3vm4e84', 'l3vm4e88'],
        compSchemaId: '162b65ee-08d2-4c4e-84fc-e9583958b88c',
      },
      l3vm4e60: {
        id: 'l3vm4e60',
        ...
        title: 'Stack',
        children: ['l3vm4e8c', 'l3vm4e8g', 'l3vm4e8k', 'l3vm4e8o', 'l3vm4e8s'],
        compSchemaId: '162b65ee-08d2-4c4e-84fc-e9583958b88c',
      },
      l3vm4e64: {
        id: 'l3vm4e64',
      ...
      l3vm4e80: {
        ...
        props: {
          ...
          label: 'Нефинансовые последствия',
          columns: [
            {
              key: '1',
              name: 'ID',
  ...
  '62d5f89a-1e10-4c64-8a00-0d0eb0c50588': {
    id: '62d5f89a-1e10-4c64-8a00-0d0eb0c50588',
    title: 'DimensionNode',
    componentName: 'DimensionNode',
    type: 'COMP',
    data: {
      ROOT_ID: {
        id: 'ROOT_ID',
    ...
    data: {
      ...
      l3vm4e3w: {
        ...
        props: {
          label: 'Необходимо согласование ответственного',
          boxSide: 'start',
          dontConvertFalseToUndefined: true,
        },
        title: 'co86_bol_needApproveBM',
        bindings: 'bindings',
        compSchemaId: 'ee4254ef-9099-9089-7468-89ce733b3376',
      ...
      l3vm4e50: {
        ...
        title: 'Admin',
        children: ['l4pfow7k', 'l4piy2l9', 'l4sa40tz', 'l4sauce6', 'l3vm4e64', 'l3vm4e66', 'l3vm4e68'],
        compSchemaId: 'f6b1a985-be84-474e-a4a5-164a76eec249',
      },
      l3vm4e52: {
        id: 'l3vm4e52',
  ...
  '162b65ee-08d2-4c4e-84fc-e9583958b88c': {
    ...
    data: {
      ROOT_ID: {
        ...
        title: 'stackRoot',
        children: ['l3wxqgwh', 'l3wxqwrt', 'l3wxp1nl', 'l3wxpefm'],
        compSchemaId: 'ee4254ef-9099-4289-be68-51ce733b3376',
      },
      l344mcvn: {
        id: 'l344mcvn',
  ...
  'ee4254ef-9099-4289-be68-51ce733b3376': {
    ...
    data: {
      ...
      l3wxw1o2: {
        ...
        title: 'Stack',
        children: ['ee4254efs9099', 'ee4254efp9099', 'l3vhkrvd', 'l39uoujr', 'l32zobsf'],
        compSchemaId: '162b65ee-08d2-4c4e-84fc-e9583958b88c',
      },
      l3wxy160: {
        id: 'l3wxy160',
  ...
  'a223f9fc-bce5-4988-9fc9-c2ecc976b76d': {
    id: 'a223f9fc-bce5-4988-9fc9-c2ecc976b76d',
    title: 'EditableText',
  ...
  '96cc8e0c-69af-44c7-b9c3-2339dc6e545f': {
    ...
    data: {
      ...
      l4mh2le5: {
        ...
        name: 'l4mh2le6',
        title: 'ss',
        compSchemaId: 'a223f9fc-bce5-4988-9fc9-c2ecc976b76d',
      },
      l4mth1vh: {
        id: 'l4mth1vh',
        name: 'l4mth1vi',
    ...
    data: Array(10000)
      ...
      .reduce(
        (acc, item, i) => {
          ...
          const randomIndex = getRandomIntInclusive(0, accIds.length - 1 || 0)

          const randomId = accIds[randomIndex]

          if (acc[randomId].children) {
            acc[randomId].children?.push(id)
          } else {
            acc[randomId].children = [id]
          }
          ...
          acc[id] = {
            ...
            title: id,
            compSchemaId: '62d5f89a-1e10-4c64-8a00-0d0eb0c50588',
          }
  ...
  '5778a519-36c7-49f5-a36a-1b5ac280b51b': {
    ...
    data: {
      ...
      l4ntw9xs: {
        ...
        name: 'l4ntw9xt',
        title: 'Pivot',
        children: ['l4ntwb4i', 'l4ntwdt4', 'l4ntwdmr'],
        compSchemaId: 'afaa57e6-1925-4b1b-933a-cb7af80587af',
      },
      l4ntwb4i: {
        id: 'l4ntwb4i',
      ...
      l4ntwdt4: {
        ...
        title: 'PivotItem',
        children: ['l4ntyyey', 'l34jmnpk', 'l34jn3df', 'l3cos3vi', 'l3wyonns'],
        compSchemaId: 'f6b1a985-be84-474e-a4a5-164a76eec249',
      },
      l4nty9cn: {
        id: 'l4nty9cn',
  ...
  '388e284e-3c72-495d-b824-f21d2b654b89': {
    id: '388e284e-3c72-495d-b824-f21d2b654b89',
    title: 'ManagementOrg',
    componentName: null,
    type: 'FORM',
    data: {
      ROOT_ID: {
        ...
        title: 'stackRoot',
        children: ['l4mtm4q4', 'l4mt63rx', 'l4mt7034', 'l4msrzit', 'l4msmwv7'],
        compSchemaId: 'ee4254ef-9099-4289-be68-51ce733b3376',
      },
      l4mshyug: {
        id: 'l4mshyug',
        name: 'id',
        props: {
          info: 'Идентификатор узла орг.структуры',
          label: 'id',
        },
        title: 'TextField',
        compSchemaId: 'ee4234ef-9099-8943-8968-51c00733b870',
      ...
      l4msj17t: {
        ...
        name: 'name',
        props: {
          info: 'Название узла орг.структуры',
          label: 'name',
        },
        title: 'TextField',
        compSchemaId: 'ee4234ef-9099-8943-8968-51c00733b870',
        defaultValue: 'Головной офис',
      },
      l4mskmwg: {
        id: 'l4mskmwg',
        name: 'valid_from',
      ...
      l4mskxxy: {
        ...
        title: 'DatePicker',
        compSchemaId: '8550ad0f-ee1f-448c-a465-458d69b69e0c',
        defaultValue: '253402203600',
      },
      l4msmwv7: {
        id: 'l4msmwv7',
        name: 'l4msmwv8',
        title: 'Pivot',
        children: ['l4msn4iz', 'l4mtugt3'],
        compSchemaId: 'afaa57e6-1925-4b1b-933a-cb7af80587af',
      },
      l4msn4iz: {
        id: 'l4msn4iz',
        ...
        title: 'PivotItem',
        children: ['l4mshyug', 'l4qsdfjw', 'l4msj17t', 'l4mskmwg', 'l4mskxxy', 'l4mtk8xd'],
        compSchemaId: 'f6b1a985-be84-474e-a4a5-164a76eec249',
      },
      l4msrzit: {
        id: 'l4msrzit',
      ...
      l4mtugt5: {
        ...
        props: {
          ...
          columns: [
            ...
            {
              key: 'assoc_path',
              name: 'Ассоциированный путь',
              text: 'assoc_path',
              maxWidth: 200,
              minWidth: 50,
              fieldName: 'assoc_path',
              isResizable: true,
            },
          ],
          compact: true,
  ...
  'c0ab931e-41c5-44ad-b12f-99e20e2bb903': {
    id: 'c0ab931e-41c5-44ad-b12f-99e20e2bb903',
    title: 'NonFinancialEffect',
    componentName: null,
    type: 'FORM',
    data: {
      ROOT_ID: {
        ...
        title: 'stackRoot',
        children: ['l4nt72rl', 'l4nt66c2', 'l4nt66c4', 'l4nt66cg'],
        compSchemaId: 'ee4254ef-9099-4289-be68-51ce733b3376',
      },
      l4nt66c2: {
        id: 'l4nt66c2',
      ...
      l4nt66cc: {
        ...
        title: 'LocationStack',
        children: ['l4nt66ck', 'l4nt66cm', 'l4nt66co', 'l4nt66cq', 'l4nt66cs', 'l4nt66cu'],
        compSchemaId: '162b65ee-08d2-4c4e-84fc-e9583958b88c',
      },
      l4nt66ce: {
        id: 'l4nt66ce',
      ...
      l4nt66cg: {
        ...
        title: 'Pivot',
        children: ['l4nt66cy', 'l4nt66d0', 'l4nt66d2', 'l4nt66d4'],
        compSchemaId: 'afaa57e6-1925-4b1b-933a-cb7af80587af',
      },
      l4nt66ci: {
        id: 'l4nt66ci',
      ...
      l4nt66d4: {
        ...
        title: 'Admin',
        children: ['l4nt66dm', 'l4nt66do', 'l4nt66dq'],
        compSchemaId: 'f6b1a985-be84-474e-a4a5-164a76eec249',
      },
      l4nt66d6: {
        id: 'l4nt66d6',
      ...
      l4nt66dk: {
        ...
        title: 'AttachmentsTable',
        children: ['l4nt66dw', 'l4nt66dy', 'l4nt66e0', 'l4nt66e2'],
        injections: [{}],
        compSchemaId: '5778a519-36c7-49f5-a36a-1b5ac280b51b',
      },
      l4nt66dm: {
      ...
      l4ntbpzo: {
        ...
        title: 'Stack',
        children: ['l4nt66d6', 'l4nt66d8', 'l4ntgkdy', 'l4ntgtix', 'l4nt66dc', 'l4nt66de', 'l4nt66dg'],
        compSchemaId: '162b65ee-08d2-4c4e-84fc-e9583958b88c',
      },
      l4ntfr47: {
        id: 'l4ntfr47',
        name: 'co88_str_otherEffectType',
        props: {
          label: 'Другие качественные потери',
        },
        title: 'TextField',
        compSchemaId: 'ee4234ef-9099-8943-8968-51c00733b870',
      },
  ...
  'cd1c9df4-f5dd-426c-9d26-a0ec40638601': {
    ...
    data: {
      ...
      l4ntku65: {
        ...
        name: 'l4ntku66',
        title: 'Pivot',
        children: ['l4ntkx1f', 'l4ntkyo1', 'l4ntkycp'],
        compSchemaId: 'afaa57e6-1925-4b1b-933a-cb7af80587af',
      },
      l4ntkx1f: {
        id: 'l4ntkx1f',
      ...
      l4ntkyo1: {
        ...
        title: 'PivotItem',
        children: ['l3vku20e', 'l3wxh4oj', 'l3wxhhrj'],
        compSchemaId: 'f6b1a985-be84-474e-a4a5-164a76eec249',
      },
      l4ntn0rh: {
        id: 'l4ntn0rh',
  ...
  'ee4254ef-9099-9089-7468-89ce733b3376': {
    ...
    data: {
      ...
      l32u8w8k: {
        id: 'l32u8w8k',
        name: 'props.сonvertFalseToUndefined',
        props: {
          label: 'convert false to undefined',
          boxSide: 'start',
          сonvertFalseToUndefined: true,
        },
        title: 'сonvertFalseToUndefined',
        l32tx8ac: false,
        compSchemaId: 'ee4254ef-9099-9089-7468-89ce733b3376',
      },
      l3vk5rtn: {
      ...
      l3wxtb3p: {
        ...
        title: 'Stack',
        children: ['l3vk5rtn', 'l4go2jax'],
        compSchemaId: '162b65ee-08d2-4c4e-84fc-e9583958b88c',
      },
      l4fngvql: {
        id: 'l4fngvql',
        name: 'props.defaultChecked',
        props: {
          label: 'default value',
          boxSide: 'start',
          сonvertFalseToUndefined: true,
      ...
      l4o00eys: {
        ...
        title: 'Pivot',
        children: ['l4o00hzy', 'l4o00jc6', 'l4o00j7a'],
        compSchemaId: 'afaa57e6-1925-4b1b-933a-cb7af80587af',
      },
      l4o00hzy: {
        id: 'l4o00hzy',
